    ...
    <footer className="bg-[#1E40AF] text-white pt-12 pb-6">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row flex-wrap gap-8 justify-between">
          <div className="w-full md:w-auto flex flex-col gap-2">
            <div className="max-w-[134px] mb-4">
              <Link href="/" className="inline-block text-2xl font-bold mb-5">
                Click Maart
              </Link>
            </div>
            <p className="mb-4 w-[300px]">{t("footer.description")}</p>
          ...
          <div className="w-full md:w-auto">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                <Link
                  href="mailto:support@clickmaart.com"
        ...
        <div className="text-center mt-12 text-sm">
          &copy; 2025-{new Date().getFullYear()} Click Maart.{" "}
